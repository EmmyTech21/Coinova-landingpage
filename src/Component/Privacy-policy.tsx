...
<section className="p-8 max-w-4xl mx-auto">
      ...
      <h2 className="text-2xl font-semibold mb-2 text-[#172A3A]">Information Collection</h2>
      <p className="text-gray-700 mb-4">
        We collect information you provide directly to us when signing up, such as your name, email address, and phone number, to give you early access and updates.
      </p>
      <h2 className="text-2xl font-semibold mb-2 text-[#172A3A]">Use of Information</h2>
      <p className="text-gray-700 mb-4">
        Your information is used solely to improve our services, communicate with you, and provide you with a secure crypto trading experience. We do not share your personal information with third parties without consent.
      </p>
      <h2 className="text-2xl font-semibold mb-2 text-[#172A3A]">Data Security</h2>
      <p className="text-gray-700 mb-4">
        We implement industry-standard security measures to protect your data from unauthorized access, alteration, or destruction. Your privacy and security are paramount to us.
      </p>
      <h2 className="text-2xl font-semibold mb-2 text-[#172A3A]">Changes to This Policy</h2>
      <p className="text-gray-700 mb-4">
        Coinova may update this Privacy Policy periodically. We will notify you of significant changes and revise the date at the top of this policy accordingly.
      </p>
      <p className="text-gray-700 mb-4">
